            ...
            <div class="row">
                <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center justify-content-xxl-center mb-3 mb-4 py-2 px-4 py-2 px-4 banner_info">
                    <div>
                        ...
                        <a class="btn btn-primary fs-5 me-2 py-2 px-4" role="button" href="/pojazdy">Sprawdź ofertę</a>
...
<footer class="text-center">
    <div class="container text-white py-4 py-lg-5">
        <ul class="list-inline">
            <li class="list-inline-item me-4"><a class="link-light" href="#">Regulamin</a></li>
            <li class="list-inline-item me-4"><a class="link-light" href="#">FAQ</a></li>
            <li class="list-inline-item"><a class="link-light" href="#">Kontakt</a></li>
        </ul>
        <ul class="list-inline">
        ...
        <p class="mb-0">Copyright © 2022 Car Rental - profesjonalna wypożyczalnia pojazdów</p>
    </div>
</footer>
