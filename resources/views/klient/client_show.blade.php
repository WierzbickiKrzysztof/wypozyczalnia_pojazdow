    ...
    <div class="container-fluid" style="margin-bottom: 50px;">
        <div class="row">
            <div class="col-12 col-sm-6 col-md-6">
                <h3 class="text-white mb-4">Lista Klientów</h3>
            ...
            <div class="card-header py-3" style="border-width: 0px;background: rgb(23,25,33);">
                <div class="row table-topper align-items-center">
                    <div class="col-12 col-sm-5 col-md-6 text-start" style="margin: 0px;padding: 5px 15px;">
                        <p class="m-0 fw-bold" style="color: rgb(255,255,255);">Klienci</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <table id="ipi-table" class="table table-striped table tablesorter">
                            ...
                            @foreach($users as $users)
                                ...
                                <tr style="background: #262a38;">
                                    ...
                                    <td class="text-center align-middle" style="max-height: 60px;height: 60px;"><a class="btn btnMaterial btn-flat success semicircle" role="button" href="/klient/client_edit/{{ $users->id }}" style="color: rgb(0,197,179);"><i class="fas fa-pen"></i></a>
