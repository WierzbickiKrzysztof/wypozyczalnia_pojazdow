...
<x-layout>
    ...
    <form method="POST" action="{{ route('rezerwacja.store_client') }}">
        @csrf
        <div class="col-md-4 mx-auto card bg-secondary border-info mb-5">
            <div class="card-body p-sm-5">


                <div class="mb-3" id="data_rozpoczecia_h" >
                ...
                <div class="mb-3" id="data_zakonczenia_h">
                ...
                <div class="mb-3" id="typ_pojazdu_h" style="display: none">
                ...
                <!--<div class="mb-3" id="klient_h" style="display: none">
