...
// Klienci //
// SHOW: Lista Klienci
Route::get('/klient/client_show', [KlientController::class, 'index'])->name('klient.index')->middleware('auth');
...
Route::get('/wypozyczenia/{wypozyczenia}', [WypozyczeniaController::class, 'update'])->name('wypozyczenia.update')->middleware('auth');
